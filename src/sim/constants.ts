...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  minefield: { name: 'Deploy Minefield', cost: 700, cd: 90, key: 'L', requires: 'cyber', desc: 'Scatter a cluster of proximity mines — hidden from the enemy, they detonate when hostiles wander in. Seal a chokepoint or defend your base.' },
