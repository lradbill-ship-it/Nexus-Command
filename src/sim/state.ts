...
function createGame(): GameState {
  return {
    ...
    platform: Object.fromEntries(ALL_TEAMS.map(t => [t, PERSONA_STYLE[FAC[t].persona]])) as Record<number, LeaderStyle>,
    electionT: Object.fromEntries(ALL_TEAMS.map(t => [t, 270])) as Record<number, number>,
    campaign: {},
    coupT: {},
    cam: { x: 0, y: 0 },
    buildings: [], units: [], shots: [], parts: [], nodes: [], settlements: [], relays: [], vaults: [], trees: [], waterTiles: [],
    ...
    cooldowns: { emp: 0, hijack: 0, nuke: 0, thermo: 0, orbital: 0, overcharge: 0 },
