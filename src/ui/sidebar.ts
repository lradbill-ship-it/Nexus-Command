...
const unitOrder = ['harvester', 'tanker', 'hauler', 'logger', 'repair', 'envoy', 'aegis', 'recon', 'infantry', 'rocket', 'transport', 'sentrypod', 'strike', 'artillery', 'walker', 'harrier', 'aircraft', 'hunter', 'spectre', 'borer', 'cartman', 'kenny', 'stan', 'kyle', 'jedi', 'sith'];
